...
send(msg.chat_id,msg.id,"*◍ عذراً، هذا المعرف لقناة او كروب وليس لشخص ..*","md",true)  
return false
end
...
send(msg_chat_id,msg_id,'◍جاري استرجاع المشتركين الكروبات ...')
Y = 0
...
data = {
{
{text = '👤 | مبرمج السورس', url = 't.me/yqyqy6'}, 
},
{
{text = '🔘 | تواصل معنا', url = 't.me/yqyqy6'}, 
},
}
}
...
{
{text = '☢️ | اضغط هنا لتنصيب', url = 't.me/Y_Y_G1bot'}, 
},
{
{text = '🔘 | تواصل معنا', url = 't.me/yqyqy6'}, 
},
